...
const LINE_OPTIONS: { type: LineType; label: string }[] = [
  { type: "solid", label: "Line" },
  { type: "round", label: "Round Line" },
  { type: "dash", label: "Dash Line" },
  { type: "dot", label: "Dot Line" },
];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.topBar}>
        ...
        <Text style={[styles.heading, { color: colors.text }]}>Line Type</Text>
      </View>
      <Text style={[styles.subHeading, { color: colors.subText }]}>
        Choose how the note lines look on day cards
      </Text>
